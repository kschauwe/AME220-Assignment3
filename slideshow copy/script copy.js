...
var goToSlide = function(n, d)
{
  ...
  if(ani === "fade"){
	...
	for(var i = 0;1 < slideElements.length; i++){
		var ele = slideElements[i];
		ele.style.transitionDuration = d;
		if(n == (i+1) ){
			ele.style.opacity = 1;
		}
		else{
  ...
  var numElements = document.getElementById("numContainer").getElementsByClassName("button");
	//console.log(slideElements);
	for(var i = 0;1 < numElements.length; i++){
